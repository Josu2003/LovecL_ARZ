...
imgui.OnFrame(function()
        ...
        imgui.BeginChild('##ChangelogArea', imgui.ImVec2(320, 100), true)
            imgui.TextWrapped(u8(updateChangelog ~= "" and updateChangelog or "Îïèñàíèå èçìåíåíèé îòñóòñòâóåò."))
        imgui.EndChild()
...
imgui.OnFrame(function()
    ...
    imgui.Text(u8 "Ñêðèïò:" .. nameScript .. " v2.1")
